      ...
      <div class="col-md-10">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
          <div>
            ...
            <p class="text-muted">Isi formulir berikut untuk menambahkan pasien baru</p>
          </div>
        ...
        <div class="card shadow-sm border-0">
          <div class="card-header bg-info text-white py-3">
            <h5 class="card-title mb-0">
              <i class="bi bi-person-plus me-2"></i>Formulir Data Pasien
            </h5>
          </div>
                ...
                <div class="row">
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('medical_record_number') is-invalid @enderror"
                      id="medical_record_number" name="medical_record_number" value="{{ old('medical_record_number') }}"
                      required>
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('patient_disease') is-invalid @enderror"
                      id="patient_disease" name="patient_disease" value="{{ old('patient_disease') }}" required>
                ...
                <div class="row">
                  ...
                  <div class="col-md-6 mb-3">
                    ...
                    <input type="text" class="form-control @error('insurance_info') is-invalid @enderror"
                      id="insurance_info" name="insurance_info" value="{{ old('insurance_info') }}">
